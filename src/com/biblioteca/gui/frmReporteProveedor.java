...
public class frmReporteProveedor extends JFrame implements ActionListener, ItemListener {
	...
	public frmReporteProveedor() {
		...
		JLabel lblNewLabel_1 = new JLabel("Reporte de Solicitud de Base Administrativa");
		lblNewLabel_1.setFont(new Font("Trebuchet MS", Font.BOLD, 24));
		lblNewLabel_1.setBounds(121, 18, 534, 38);
