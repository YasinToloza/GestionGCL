...
public class frmBuscarSolContrata extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmBuscarSolContrata frame = new frmBuscarSolContrata();
	...
	protected void actionPerformedBtnAgregar(ActionEvent e) {
		...
		frmBasesAdministrativas.txtSolContrata.setText(cod);
	...
	void listado1(String cod){
		...
		ArrayList<SolicitudContrata> lista=solcontrata.listarxcodsol(cod);
		...
		void listado(){
			...
			ArrayList<SolicitudContrata> data=solcontrata.listartodo();
