...
public class frmBuscarSolConparaContrato extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmBuscarSolConparaContrato frame = new frmBuscarSolConparaContrato();
	 ...
	 * Create the frame.
	 */
	public frmBuscarSolConparaContrato() {
		setResizable(false);
		...
		btnAgregar.setIcon(new ImageIcon(frmBuscarSolConparaContrato.class.getResource("/iconos/add (2).png")));
		...
		btnBuscar.setIcon(new ImageIcon(frmBuscarSolConparaContrato.class.getResource("/iconos/search.png")));
	...
	protected void actionPerformedBtnAgregar(ActionEvent e) {
		...
		int posfila;
		String cod,des,tipoC,cod_sol_abas,codCCP,fecha;
		...
		fecha=tblSolicitud.getValueAt(posfila, 5).toString();
		tipoC=tblSolicitud.getValueAt(posfila, 7).toString();
		codCCP=tblSolicitud.getValueAt(posfila, 4).toString();
		cod_sol_abas=tblSolicitud.getValueAt(posfila, 3).toString();
		frmGenerarContrato.txtSolContrata.setText(cod);
		frmGenerarContrato.txtCodSabas.setText(cod_sol_abas);
		frmGenerarContrato.txtDesSolContrata.setText(des);
		frmGenerarContrato.txtFechaSolContrata.setText(fecha);
		frmGenerarContrato.txtCodCCP.setText(codCCP);
		frmGenerarContrato.txtTipocontratoSol.setText(tipoC);
	...
	void listado1(String cod){
		...
		ArrayList<SolicitudContrata> lista=solcontrata.listarporcritparacontrato(cod);
		...
		void listado(){
			...
			ArrayList<SolicitudContrata> data=solcontrata.listarparacontrato1();
